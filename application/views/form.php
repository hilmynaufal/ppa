                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tr><td>Datalist</td><td><?php echo datalist_dinamis_skpd('test', 'ref_department', 'name') ?></td></tr>
                            <tr><td>Combobox</td><td><?php echo cmb_dinamis_skpd('test', 'ref_department', 'name', 'id_department') ?></td></tr>
                        </table>
