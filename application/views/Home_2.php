    ...
    <body>
        ...
        <header id="header" class="fixed-top ">
            <div class="container d-flex align-items-center">
                ...
                <h1 class="logo me-auto"><a href="index.html"><font style="color:#ff9900">PPA</font> BEDAS</a></h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                        <h1>PPA BEDAS</h1>
                        <h2>Pelaporan Perlindungan Perempuan dan Anak </h2>
                    ...
                    <div class="card border-primary rounded-0">
                        <div class="card-header p-0">
                            <div class="bg-info text-white text-center py-2">
                                ...
                                <p class="m-0">Pembuatan Akun Pelaporan</p>
                            </div>
                        </div>
                        <div class="card-body p-12">
                            <form action="<?php echo $action; ?>" method="post">
                                ...
                                <table class='table table-bordered'>
                                    <tr>
                                        <td width='200'>Nik <?php echo form_error('nik') ?></td><td><input type="text" class="form-control" name="nik" id="nik" placeholder="Nik" value="" /></td>
                                    </tr>

                                    <tr>
                                        <td width='200'>Nama Lengkap <?php echo form_error('full_name') ?></td><td><input type="text" class="form-control" name="full_name" id="full_name" placeholder="Full Name" value="" /></td>
                                    </tr>

                                    <tr>
                                        <td width='200'>Kota Lahir <?php echo form_error('kota_lahir') ?></td><td><input type="text" class="form-control" name="kota_lahir" id="kota_lahir" placeholder="Kota Lahir" value="" /></td>
                                    </tr>

                                    <tr>
                                        <td width='200'>Tanggal Lahir <?php echo form_error('birth') ?></td>
                                        <td><input type="date" class="form-control" name="birth" id="birth" placeholder="Birth" value="" /></td>
                                    </tr>

                                    <tr>
                                        <td width='200'>Email <?php echo form_error('email') ?></td><td><input type="text" class="form-control" name="email" id="email" placeholder="Email" value="" /></td>
                                    </tr>
                                    <tr>
                                        <td width='200'>Hp/Telepon Aktif <?php echo form_error('phone') ?></td><td><input type="text" class="form-control" name="phone" id="phone" placeholder="No HP / Telp" value="" /></td>
                                    </tr>
                                    ...
                                    <input type="hidden" class="form-control" name="username" id="username" placeholder="Username" value="" />

                                    <tr>
                                        <td width='200'>Password <?php echo form_error('password') ?></td><td><input type="password" class="form-control" name="password" id="password" placeholder="Password" value="" /></td>
                                    </tr>
                                    <tr>
                                        <td width='200'>Ulangi Password  <?php echo form_error('confirm_password') ?></td><td><input type="password" class="form-control" name="confirm_password" id="confirm_password" placeholder="Ulangi Password" value="" /></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td> <textarea class="form-control" rows="3" name="alamat_domisili" id="alamat_domisili" placeholder="Alamat Domisili"> </textarea></td>
                                    </tr>
                    ...
                    <div class="faq-list">
                        <ul>
                            <li data-aos="fade-up" data-aos-delay="100">
                                <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">Apa itu Rumina? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                                <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                                    <p>
                                        Rumina adalah Rumah Informasi Pertanahan Kecamatan Soreang
                                    </p>
                                </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="200">
                                <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">Siapa saja yang mendapatkan Rumina Kab.Bandung? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                                <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        Seluruh Masyarakat Yang melakukan Penyampain berkas permohonan pengesahan Akta Jual Beli/Hibah/APHB Ke Kecamatan Soreang
                                    </p>
                                </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="300">
                                <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Bagaimana cara masuk ke dalam aplikasi Rumina? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                                <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        Seluruh Masyarakat yang menyampaikan  permohonan pengesahan Akta Jual Beli dapat melihat resi
                                    </p>
                                </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="400">
                                <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">Bagaimana Standar Operasional Prosedur (SOP) Rumina? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                                <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">

                                    <embed src="https://rumina.kecamatansoreang.bandungkab.go.id/sop/SOP_PPAT_KECAMATAN_SOREANG.pdf" type="application/pdf" width="100%" height="600px" />
                                </div>
                            </li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            <h4>Tautan</h4>
                            <ul>
                                <li><i class="bx bx-chevron-right"></i> <a href="https://kecamatansoreang.bandungkab.go.id">Kecamatan Soreang</a></li>
                                <li><i class="bx bx-chevron-right"></i> <a href="https://twitter.com/kantahkabbdg">BPN KAB.BANDUNG</a></li>
                                <li><i class="bx bx-chevron-right"></i> <a href="https://bandungkab.go.id">PORTAL BANDUNGKAB</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            ...
                            <div class="social-links mt-3">
                                <a href="https://twitter.com/kantahkabbdg" class="twitter"><i class="bx bxl-twitter"></i></a>
                                <a href="https://www.instagram.com/bandungpemkab/" class="instagram"><i class="bx bxl-facebook"> </i></a>
