    ...
    <body>
        ...
        <header id="header" class="fixed-top ">
            <div class="container d-flex align-items-center">
                ...
                <h1 class="logo me-auto"><a href="index.html"><font style="color:#ff9900">SIPETIK</font> BEDAS</a></h1>
                                        ...
                                        <form action="<?php echo $action; ?>" method="post">
                                            ...
                                            <table class='table table-bordered'>
                                                ...
                                                <input type="hidden" class="form-control" name="username" id="username" placeholder="Username" value="" />
                                                 <input type="hidden" class="form-control" name="id_user_level" id="id_user_level" placeholder="id_user_level" value="3" />

                                                <tr>
                                                    <td width='200'>Password <?php echo form_error('password') ?></td><td><input type="text" class="form-control" name="password" id="password" placeholder="Password" value="" /></td>
                                                </tr>
                                                 <tr>
                                                    <td width='200'>Konfirmasi Password <?php echo form_error('confirm_password') ?></td><td><input type="text" class="form-control" name="confirm_password" id="confirm_password" placeholder="Konfirmasi Password" value="" /></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td width='200'>Pekerjaan <?php echo form_error('pekerjaan') ?></td><td><input type="text" class="form-control" name="pekerjaan" id="pekerjaan" placeholder="Pekerjaan" value="" /></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <textarea class="form-control" rows="3" name="ket_laporan" id="ket_laporan" placeholder="Ket Laporan"></textarea></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>
                    ...
                    <div class="faq-list">
                        <ul>
                            <li data-aos="fade-up" data-aos-delay="100">
                                <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">Apa itu Sipetik? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                                <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                                    <p>
                                        Sistem Informasi pelaporan dan tindak kekerasan perempuan dan anak Pemerintah Kabupaten Bandung 
                                    </p>
                                </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="200">
                                <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">Siapa saja yang mendapatkan Akses Sipetik Kab.Bandung? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                            ...
                            <li data-aos="fade-up" data-aos-delay="300">
                                <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Bagaimana cara masuk ke dalam aplikasi Sipetik? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                                <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        Dengan cara melakukan pendaftaran atau melaporkan kepada pihak terkait ditiap kecamatan di wilayah Kabupaten Bandung
                                    </p>
                                </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="400">
                                <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">Bagaimana Standar Operasional Prosedur (SOP) Sipetik? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
...
<div class="mySlides fade">
  ...
  <img src="<?PHP echo base_url() ?>/assets/hero/img/1.png" style="width:100%">
  <div class="text"> </div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="<?PHP echo base_url() ?>/assets/hero/img/2.png" style="width:100%">
  <div class="text"> </div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="<?PHP echo base_url() ?>/assets/hero/img/3.png" style="width:100%">
  <div class="text"> </div>
</div>
<div class="mySlides fade">
  <div class="numbertext">3 / 4</div>
  <img src="<?PHP echo base_url() ?>/assets/hero/img/4.png" style="width:100%">
  <div class="text"> </div>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            ...
                            <ul>
                                ...
                                <li><i class="bx bx-chevron-right"></i> <a href="https://dp2kbp3a.bandungkab.go.id/">DP2KBP3A</a></li>
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            ...
                            <div class="social-links mt-3">
                                ...
                                <a href="https://www.instagram.com/uptd_ppa_kab_bandung/" class="instagram"><i class="bx bxl-instagram"></i></a>
