...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">RUMINA BEDAS</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#about">Rumina</a></li>
...
<!--    <section id="cliens" class="cliens section-bg">
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flesx align-items-center justify-content-center" data-bs-toggle="tooltip" data-bs-placement="top" title="BPHN">
...
.panel-heading-nav .nav {
  ...
  padding-right: 10px;
		...
		<h2 class="text-center p-3">Informasi Akta  </h2>
                <p class="text-center p-3"> No Resi :<?php echo $resi; ?></p>
		<nav>
		...
		<div class="tab-content p-3 border bg-light" id="nav-tabContent">
			<div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
				<table class="table table-striped table-bordered" >
                                         ...
                                         <tr>
                                             <td>Kode Register</td>
                                             <td><?php echo $kode_akta; ?></td>
                                         </tr>
                                         <tr>
                                             <td>Nama Pemohon Penjual</td>
                                             <td><?php echo $penjual; ?></td>
                                         </tr>
                                         <tr>
                                             <td>Nama Pemohon Pembeli</td>
                                         ...
                                         <tr>
                                             <td>Status Berkas</td>
                                             <td><?php echo $keterangan_proses; echo $status_berkas;?></td>
                                         </tr>
                                          <tr>
                                             <td>
                                             
                                            
                                             <a href="<?php echo site_url() ;?>" class="btn btn-default"><button class="btn btn-success"><i class="fa fa-book"></i>Kembali</button></a>
                                             
                                             
                                             
                                             </td>
                                             <td>
                                              <?PHP if($status_berkas==1) {?>
                                             <a href="<?php echo site_url('home/cetak_resi/'.($resi)."")  ?>"><button class="btn btn-success"><i class="fa fa-book"></i>Cetak Resi</button></a>
                                              <?PHP  }?>
                                              
                                              
                                              
                                                <?PHP if($status_berkas==4)  {?>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Rumina</a></li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Informasi Akta</h5>
